...
const api_url_tech =`https://newsapi.org/v2/everything?q=Technology&apiKey=${apikey}`;
const api_url_sports =`https://newsapi.org/v2/everything?q=Sports&apiKey=${apikey}`;
const api_url_entertainment =`https://newsapi.org/v2/everything?q=Entertainment&apiKey=${apikey}`;
