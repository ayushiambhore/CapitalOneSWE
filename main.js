...
const apikey = '0a30ecf8c61897c51135fec3c190ffde';
//'0bc0004f540d4de4855f145185f08a9d';
let topic= 'Sports';

const api_url =`https://gnews.io/api/v4/search?q=Sports&token=${apikey}`
...
function show(data) { 
      ...
      for (var i=0;i<data.articles.length;i++) {
        ...
        tab += `<tr> <th>Content : </th><td> ${data.articles[i].content} </td> 
        </tr>`; 
        ...
        tab += `<tr> <th>Url Image  : </th><td> <img src=${data.articles[i].image} width='150' height='100'></img></td> 
        </tr>`; 
